...
/*Line of code for my sql injection
Database connection-cons
stmt- Checks if the statement was prepared successfully. If false, it stops execution and outputs an error (die).
params- Binds parameters to the prepared query.
Errors in query preparation trigger an immediate termination with an error message.
*/
    ...
    <main id="main" class="main">
        ...
        <?php if ($status): ?>
            <div class="alert alert-<?php echo ($status == 'error') ? 'danger' : 'success'; ?> alert-dismissible fade show" role="alert">
                <?php 
                    if ($status == 'success') {
                        echo !empty($success_message) ? $success_message : "New record has been created successfully!";
                    } elseif ($status == 'updated') {
                        echo "Record has been updated successfully!";
                    } elseif ($status == 'deleted') {
                        echo "Record has been deleted successfully!";
                    } else {
                        echo !empty($error_message) ? $error_message : "An error occurred.";
                    }
                ?>
                ...
                <div class="col-lg-12">
                                ...
                                <tbody>
                                    <?php if ($barangay_officials->num_rows > 0): ?>
                                        <?php while ($row = $barangay_officials->fetch_assoc()): ?>
                                            <tr>
                                                <!-- fetches and displays database records of barangay officials in an HTML table, ensuring security and proper data handling.-->
                    ...
                    <div class="modal fade" id="viewModal" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">View Barangay Officials</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                </div>
                                <div class="modal-body">
